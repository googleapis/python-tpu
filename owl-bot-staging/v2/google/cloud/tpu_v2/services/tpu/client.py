...
from .transports.rest import TpuRestTransport
...
class TpuClient(metaclass=TpuClientMeta):
    ...
    @staticmethod
    def accelerator_type_path(project: str,location: str,accelerator_type: str,) -> str:
        """Returns a fully-qualified accelerator_type string."""
        return "projects/{project}/locations/{location}/acceleratorTypes/{accelerator_type}".format(project=project, location=location, accelerator_type=accelerator_type, )

    @staticmethod
    def parse_accelerator_type_path(path: str) -> Dict[str,str]:
        """Parses a accelerator_type path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/acceleratorTypes/(?P<accelerator_type>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def node_path(project: str,location: str,node: str,) -> str:
        """Returns a fully-qualified node string."""
        return "projects/{project}/locations/{location}/nodes/{node}".format(project=project, location=location, node=node, )

    @staticmethod
    def parse_node_path(path: str) -> Dict[str,str]:
        """Parses a node path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/nodes/(?P<node>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def runtime_version_path(project: str,location: str,runtime_version: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/runtimeVersions/{runtime_version}".format(project=project, location=location, runtime_version=runtime_version, )

    @staticmethod
    def parse_runtime_version_path(path: str) -> Dict[str,str]:
        """Parses a runtime_version path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/runtimeVersions/(?P<runtime_version>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def list_nodes(self,
        ...
        Args:
            request (Union[google.cloud.tpu_v2.types.ListNodesRequest, dict]):
    ...
    def create_node(self,
        ...
        Args:
            request (Union[google.cloud.tpu_v2.types.CreateNodeRequest, dict]):
                The request object. Request for
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.tpu_v2.types.Node` A TPU instance.
    ...
    def delete_node(self,
        ...
        Args:
            request (Union[google.cloud.tpu_v2.types.DeleteNodeRequest, dict]):
                The request object. Request for
    ...
    def stop_node(self,
        ...
        Args:
            request (Union[google.cloud.tpu_v2.types.StopNodeRequest, dict]):
                The request object. Request for
    ...
    def start_node(self,
        ...
        Args:
            request (Union[google.cloud.tpu_v2.types.StartNodeRequest, dict]):
                The request object. Request for
    ...
    def update_node(self,
        ...
        Args:
            request (Union[google.cloud.tpu_v2.types.UpdateNodeRequest, dict]):
                The request object. Request for
    ...
    def generate_service_identity(self,
        ...
        Args:
            request (Union[google.cloud.tpu_v2.types.GenerateServiceIdentityRequest, dict]):
                The request object. Request for
    ...
    def list_accelerator_types(self,
        ...
        Args:
            request (Union[google.cloud.tpu_v2.types.ListAcceleratorTypesRequest, dict]):
                The request object. Request for
    ...
    def get_accelerator_type(self,
        ...
        Args:
            request (Union[google.cloud.tpu_v2.types.GetAcceleratorTypeRequest, dict]):
                The request object. Request for
    ...
    def list_runtime_versions(self,
        ...
        Args:
            request (Union[google.cloud.tpu_v2.types.ListRuntimeVersionsRequest, dict]):
                The request object. Request for
    ...
    def get_runtime_version(self,
        ...
        Args:
            request (Union[google.cloud.tpu_v2.types.GetRuntimeVersionRequest, dict]):
                The request object. Request for
    ...
    def get_guest_attributes(self,
        ...
        Args:
            request (Union[google.cloud.tpu_v2.types.GetGuestAttributesRequest, dict]):
                The request object. Request for
