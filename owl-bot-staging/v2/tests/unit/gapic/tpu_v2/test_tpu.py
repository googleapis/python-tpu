...
from google.cloud.tpu_v2.services.tpu import TpuAsyncClient
from google.cloud.tpu_v2.services.tpu import TpuClient
from google.cloud.tpu_v2.services.tpu import pagers
from google.cloud.tpu_v2.services.tpu import transports
...
def test_tpu_client_client_options_from_dict():
    with mock.patch('google.cloud.tpu_v2.services.tpu.transports.TpuGrpcTransport.__init__') as grpc_transport:
...
async def test_list_nodes_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_nodes(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_list_accelerator_types_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_accelerator_types(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
async def test_list_runtime_versions_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_runtime_versions(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_list_nodes_rest_unset_required_fields():
    transport = transports.TpuRestTransport(credentials=ga_credentials.AnonymousCredentials)
...
def test_list_nodes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.TpuRestInterceptor, "post_list_nodes") as post, \
         mock.patch.object(transports.TpuRestInterceptor, "pre_list_nodes") as pre:
        ...
        req.return_value._content = cloud_tpu.ListNodesResponse.to_json(cloud_tpu.ListNodesResponse())
...
def test_list_nodes_rest_bad_request(transport: str = 'rest', request_type=cloud_tpu.ListNodesRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_nodes_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v2/{parent=projects/*/locations/*}/nodes" % client.transport._host, args[1])
...
def test_get_node_rest_required_fields(request_type=cloud_tpu.GetNodeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_node._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_node_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TpuRestInterceptor, "post_get_node") as post, \
         mock.patch.object(transports.TpuRestInterceptor, "pre_get_node") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.get_node(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_node_rest_bad_request(transport: str = 'rest', request_type=cloud_tpu.GetNodeRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_node_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/locations/*/nodes/*}" % client.transport._host, args[1])
...
def test_create_node_rest_required_fields(request_type=cloud_tpu.CreateNodeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).create_node._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_create_node_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("nodeId", )) & set(("parent", "node", )))
...
def test_create_node_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.TpuRestInterceptor, "post_create_node") as post, \
         mock.patch.object(transports.TpuRestInterceptor, "pre_create_node") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.create_node(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_create_node_rest_bad_request(transport: str = 'rest', request_type=cloud_tpu.CreateNodeRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_delete_node_rest_required_fields(request_type=cloud_tpu.DeleteNodeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).delete_node._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_delete_node_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.TpuRestInterceptor, "post_delete_node") as post, \
         mock.patch.object(transports.TpuRestInterceptor, "pre_delete_node") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.delete_node(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_delete_node_rest_bad_request(transport: str = 'rest', request_type=cloud_tpu.DeleteNodeRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_stop_node_rest_required_fields(request_type=cloud_tpu.StopNodeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).stop_node._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_stop_node_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.TpuRestInterceptor, "post_stop_node") as post, \
         mock.patch.object(transports.TpuRestInterceptor, "pre_stop_node") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.stop_node(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_stop_node_rest_bad_request(transport: str = 'rest', request_type=cloud_tpu.StopNodeRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_start_node_rest_required_fields(request_type=cloud_tpu.StartNodeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).start_node._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_start_node_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.TpuRestInterceptor, "post_start_node") as post, \
         mock.patch.object(transports.TpuRestInterceptor, "pre_start_node") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.start_node(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_start_node_rest_bad_request(transport: str = 'rest', request_type=cloud_tpu.StartNodeRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_node_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'node': {'name': 'projects/sample1/locations/sample2/nodes/sample3'}}
...
def test_update_node_rest_required_fields(request_type=cloud_tpu.UpdateNodeRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).update_node._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_update_node_rest_unset_required_fields():
    ...
    assert set(unset_fields) == (set(("updateMask", )) & set(("updateMask", "node", )))
...
def test_update_node_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.TpuRestInterceptor, "post_update_node") as post, \
         mock.patch.object(transports.TpuRestInterceptor, "pre_update_node") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        ...
        client.update_node(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_update_node_rest_bad_request(transport: str = 'rest', request_type=cloud_tpu.UpdateNodeRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_update_node_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'node': {'name': 'projects/sample1/locations/sample2/nodes/sample3'}}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{node.name=projects/*/locations/*/nodes/*}" % client.transport._host, args[1])
...
def test_generate_service_identity_rest_required_fields(request_type=cloud_tpu.GenerateServiceIdentityRequest):
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).generate_service_identity._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_generate_service_identity_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TpuRestInterceptor, "post_generate_service_identity") as post, \
         mock.patch.object(transports.TpuRestInterceptor, "pre_generate_service_identity") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = cloud_tpu.GenerateServiceIdentityRequest.pb(cloud_tpu.GenerateServiceIdentityRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloud_tpu.GenerateServiceIdentityResponse.to_json(cloud_tpu.GenerateServiceIdentityResponse())
        ...
        client.generate_service_identity(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_generate_service_identity_rest_bad_request(transport: str = 'rest', request_type=cloud_tpu.GenerateServiceIdentityRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_accelerator_types_rest_required_fields(request_type=cloud_tpu.ListAcceleratorTypesRequest):
    transport_class = transports.TpuRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_accelerator_types._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_accelerator_types_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TpuRestInterceptor, "post_list_accelerator_types") as post, \
         mock.patch.object(transports.TpuRestInterceptor, "pre_list_accelerator_types") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = cloud_tpu.ListAcceleratorTypesRequest.pb(cloud_tpu.ListAcceleratorTypesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloud_tpu.ListAcceleratorTypesResponse.to_json(cloud_tpu.ListAcceleratorTypesResponse())
        ...
        client.list_accelerator_types(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_accelerator_types_rest_bad_request(transport: str = 'rest', request_type=cloud_tpu.ListAcceleratorTypesRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_accelerator_types_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=projects/*/locations/*}/acceleratorTypes" % client.transport._host, args[1])
...
def test_list_accelerator_types_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(cloud_tpu.ListAcceleratorTypesResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_accelerator_type_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/acceleratorTypes/sample3'}
    request = request_type(**request_init)
...
def test_get_accelerator_type_rest_required_fields(request_type=cloud_tpu.GetAcceleratorTypeRequest):
    transport_class = transports.TpuRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_accelerator_type._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_accelerator_type_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TpuRestInterceptor, "post_get_accelerator_type") as post, \
         mock.patch.object(transports.TpuRestInterceptor, "pre_get_accelerator_type") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = cloud_tpu.GetAcceleratorTypeRequest.pb(cloud_tpu.GetAcceleratorTypeRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloud_tpu.AcceleratorType.to_json(cloud_tpu.AcceleratorType())
        ...
        client.get_accelerator_type(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_accelerator_type_rest_bad_request(transport: str = 'rest', request_type=cloud_tpu.GetAcceleratorTypeRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_accelerator_type_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/acceleratorTypes/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/locations/*/acceleratorTypes/*}" % client.transport._host, args[1])
...
def test_list_runtime_versions_rest_required_fields(request_type=cloud_tpu.ListRuntimeVersionsRequest):
    transport_class = transports.TpuRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).list_runtime_versions._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_list_runtime_versions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TpuRestInterceptor, "post_list_runtime_versions") as post, \
         mock.patch.object(transports.TpuRestInterceptor, "pre_list_runtime_versions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = cloud_tpu.ListRuntimeVersionsRequest.pb(cloud_tpu.ListRuntimeVersionsRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloud_tpu.ListRuntimeVersionsResponse.to_json(cloud_tpu.ListRuntimeVersionsResponse())
        ...
        client.list_runtime_versions(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_list_runtime_versions_rest_bad_request(transport: str = 'rest', request_type=cloud_tpu.ListRuntimeVersionsRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_list_runtime_versions_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{parent=projects/*/locations/*}/runtimeVersions" % client.transport._host, args[1])
...
def test_list_runtime_versions_rest_pager(transport: str = 'rest'):
    ...
    with mock.patch.object(Session, 'request') as req:
        ...
        # Wrap the values into proper Response objs
        response = tuple(cloud_tpu.ListRuntimeVersionsResponse.to_json(x) for x in response)
        return_values = tuple(Response() for i in response)
        for return_val, response_val in zip(return_values, response):
            return_val._content = response_val.encode('UTF-8')
            return_val.status_code = 200
...
def test_get_runtime_version_rest(request_type):
    ...
    # send a request that will satisfy transcoding
    request_init = {'name': 'projects/sample1/locations/sample2/runtimeVersions/sample3'}
    request = request_type(**request_init)
...
def test_get_runtime_version_rest_required_fields(request_type=cloud_tpu.GetRuntimeVersionRequest):
    transport_class = transports.TpuRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_runtime_version._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_runtime_version_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TpuRestInterceptor, "post_get_runtime_version") as post, \
         mock.patch.object(transports.TpuRestInterceptor, "pre_get_runtime_version") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = cloud_tpu.GetRuntimeVersionRequest.pb(cloud_tpu.GetRuntimeVersionRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloud_tpu.RuntimeVersion.to_json(cloud_tpu.RuntimeVersion())
        ...
        client.get_runtime_version(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_runtime_version_rest_bad_request(transport: str = 'rest', request_type=cloud_tpu.GetRuntimeVersionRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_get_runtime_version_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        # get arguments that satisfy an http rule for this method
        sample_request = {'name': 'projects/sample1/locations/sample2/runtimeVersions/sample3'}
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v2/{name=projects/*/locations/*/runtimeVersions/*}" % client.transport._host, args[1])
...
def test_get_guest_attributes_rest_required_fields(request_type=cloud_tpu.GetGuestAttributesRequest):
    transport_class = transports.TpuRestTransport
    ...
    unset_fields = transport_class(credentials=ga_credentials.AnonymousCredentials()).get_guest_attributes._get_unset_required_fields(jsonified_request)
    jsonified_request.update(unset_fields)
...
def test_get_guest_attributes_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.TpuRestInterceptor, "post_get_guest_attributes") as post, \
         mock.patch.object(transports.TpuRestInterceptor, "pre_get_guest_attributes") as pre:
        pre.assert_not_called()
        post.assert_not_called()
        pb_message = cloud_tpu.GetGuestAttributesRequest.pb(cloud_tpu.GetGuestAttributesRequest())
        transcode.return_value = {
            "method": "post",
            "uri": "my_uri",
            "body": pb_message,
        ...
        req.return_value.status_code = 200
        req.return_value.request = PreparedRequest()
        req.return_value._content = cloud_tpu.GetGuestAttributesResponse.to_json(cloud_tpu.GetGuestAttributesResponse())
        ...
        client.get_guest_attributes(request, metadata=[("key", "val"), ("cephalopod", "squid"),])

        pre.assert_called_once()
        post.assert_called_once()


def test_get_guest_attributes_rest_bad_request(transport: str = 'rest', request_type=cloud_tpu.GetGuestAttributesRequest):
    client = TpuClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport=transport,
    )
...
def test_tpu_base_transport():
    ...
    with mock.patch('google.cloud.tpu_v2.services.tpu.transports.TpuTransport.__init__') as Transport:
...
def test_tpu_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.tpu_v2.services.tpu.transports.TpuTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_tpu_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.tpu_v2.services.tpu.transports.TpuTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.TpuTransport()
        adc.assert_called_once()
