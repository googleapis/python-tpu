...
class TpuGrpcAsyncIOTransport(TpuTransport):
    ...
    @property
    def list_queued_resources(self) -> Callable[
    ...
    @property
    def get_queued_resource(self) -> Callable[
            [cloud_tpu.GetQueuedResourceRequest],
            Awaitable[cloud_tpu.QueuedResource]]:
    ...
    @property
    def create_queued_resource(self) -> Callable[
    ...
    @property
    def delete_queued_resource(self) -> Callable[
    ...
    @property
    def reset_queued_resource(self) -> Callable[
    ...
    def get_runtime_version(self) -> Callable[
            ...
            Awaitable[cloud_tpu.RuntimeVersion]]:
    ...
    @property
    def simulate_maintenance_event(self) -> Callable[
